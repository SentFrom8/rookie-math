    ...
    <div className="page">
      ...
      <ol>
        <li>Axiom of extensionality</li>
          ...
          <p>
            The '<CustomLatex latex={"\\small \\forall"} block={false} />' symbol simply
            ...
            <CustomLatex latex={"\\small \\iff"} block={false} />' means if and only if
        ...
        <li>Axiom of pairing</li>
          ...
          <p>
            ...
            <CustomLatex latex={"\\small \\{\\emptyset \\}"} block={false} /> have the
        ...
        <li>Axiom of the union</li>
          ...
          <p>
            ...
            <CustomLatex latex={"\\small Y = \\bigcup X"} block={false} />. It's best to
            show this with an example. Say X is a set that contains sets a and
            b.&nbsp;
            <CustomLatex latex={"\\small Y = \\bigcup \\{ a,b \\}"} block={false} /> is
        ...
        <li>Axiom of the power set</li>
          ...
          <CustomLatex latex="A = \{ a, b, c\}" />
          <CustomLatex latex="\mathcal{P}(x) = \{ \emptyset, \{a\}, \{b\}, \{a, b\}, \\ \{c\}, \{a, c\}, \{b, c\}, \{a, b, c\} \}"></CustomLatex>
          <p>
            As we can see, all elements of the power set only contain elements
            of x, and the power set contains every such set.
          </p>
        
        <li>Axiom of separation</li>
          <p>
      ...
      <p>
        ...
        simple. The set&nbsp;
        <CustomLatex latex={"\\small X = \\{X\\}"} block={false} /> can't be constructed
