  ...
  return (
    ...
    <h1>Functions</h1>
      ...
      <p>
        ...
        pointing to) is called the image of X. When we write f(1), that just means
      ...
      <p>
        ...
        preimage of the set B is the domain (A). Formally, the function is
        surjective if:
      </p>
      <CustomLatex
      ...
      />
      <p>
        The inverse function is also bijective, the domain is B
        (the codomain of f) and the codomain is A (the domain of f). In this
      ...
      <p>
        We can also have multiple mappings between sets. Say we have sets A, B,
